						...
						<div class="card mb-3 pb-2">
							<div class="card-body">
								<div class="row">
									...
									<div class="dt-rating col-sm-9 text-secondary"></div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
									...
									<div class="dt-sale col-sm-9 text-secondary"></div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
									...
									<div class="dt-descreption col-sm-9 text-secondary"></div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
									...
									<div class="dt-category col-sm-9 text-secondary"></div>
								</div>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function() {
		$("#example1").DataTable({
            pageLength: 2,
            ajax: {
                url:  "/TubeFashtion/ListProductController",
                dataSrc: '',
                data: {
                	action: "views"
                }
