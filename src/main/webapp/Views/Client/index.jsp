    ...
    <main id="main-container" class="main-container">
        ...
        <div class="hero hero-slider hero--1">
            <div class="swiper-wrapper">
                <!-- Start Hero Image -->
                <div class="hero-img hero-img--1 swiper-slide" style="background-image: url(assets/img/hero/hero-home-1-img-1.jpg);">
                ...
                <!-- Start Hero Image -->
                <div class="hero-img hero-img--1 swiper-slide" style="background-image: url(assets/img/hero/hero-home-1-img-2.jpg);">
                    <div class="hero__content">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7 col-sm-10 col-12">
                ...
                <!-- Start Hero Image -->
                <div class="hero-img hero-img--1 swiper-slide" style="background-image: url(assets/img/hero/hero-home-1-img-3.jpg);">
                    <div class="hero__content">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7 col-sm-10 col-12">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-12">
                        ...
                        <div class="cms__content">
                            ...
                            <div class="cms__text">
                                <h6 class="cms__title">Giao hàng miễn phí</h6>
                                <span class="cms__des">Cho hoá đơn trên 200.000VNĐ</span>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="cms__content">
                            ...
                            <div class="cms__text">
                                <h6 class="cms__title">Thanh toán an toàn</h6>
                                <span class="cms__des">Thanh toán an toàn 100%</span>
                            </div>
                        </div>
                    </div> <!-- End Single CMS box -->
                    <!-- Start Single CMS box -->
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="cms__content">
                            ...
                            <div class="cms__text">
                                <h6 class="cms__title">Tự tin mua sắm</h6>
                                <span class="cms__des">Hoàn trả khi gặp vấn đề</span>
                            </div>
                        </div>
                    </div> <!-- End Single CMS box -->
                    <!-- Start Single CMS box -->
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="cms__content">
                            ...
                            <div class="cms__text">
                                <h6 class="cms__title">Hỗ trợ 24/7</h6>
                                <span class="cms__des">Hỗ trợ tận tình 24/7</span>
                            </div>
                        </div>
                    </div> <!-- End Single CMS box -->
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-content section-content--border">
                            <h5 class="section-content__title ">Sảm phẩm sale mới nhất</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="product-counter-slider overflow-hidden m-t-50">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                        <div class="product__img-box">
                                            ...
                                            <div class="product__counter-box">
                                                <!-- Thời gian còn lại khuyến mãi, code ở phần JS main.js -->
                                                <div class="product__counter-item" data-countdown="2022/06/19"></div>
                                            </div>
                                    ...
                                    <div class="product__box product__box--counter product__box--border-hover swiper-slide text-center">
                                        <div class="product__img-box">
                                            <a href="single-1.html" class="product__img--link">
                                                <img class="product__img" src="assets/img/product/size-large/product-home-1-lg-img-1.jpg" alt="">
                                            </a>
                        ...
                        <div class="product-category-slider overflow-hidden  margin-reset">
                            <div class="swiper-wrapper">
                                ...
                                <div class="product__box product__box--catagory  product__box--border swiper-slide text-center">
                                    <div class="product__img-box">
                                        <a href="shop-1.html" class="product__img--link">
                                            <img class="product__img" src="assets/img/product/category/category-home-1-img-1.jpg" alt="">
                                        </a>
                                ...
                                <div class="product__box product__box--catagory  product__box--border swiper-slide text-center">
                                    <div class="product__img-box">
                                        <a href="shop-1.html" class="product__img--link">
                                            <img class="product__img" src="assets/img/product/category/category-home-1-img-2.jpg" alt="">
                                        </a>
                                        <a href="shop-1.html" class="product__link product__link--weight-regular m-t-30">
                                            Kitchen
                                        </a>
                                ...
                                <div class="product__box product__box--catagory  product__box--border swiper-slide text-center">
                                    <div class="product__img-box">
                                        <a href="shop-1.html" class="product__img--link">
                                            <img class="product__img" src="assets/img/product/category/category-home-1-img-3.jpg" alt="">
                                        </a>
                                        <a href="shop-1.html" class="product__link product__link--weight-regular m-t-30">
                                            Entertainment
                                        </a>
                                ...
                                <div class="product__box product__box--catagory  product__box--border swiper-slide text-center">
                                    <div class="product__img-box">
                                        <a href="shop-1.html" class="product__img--link">
                                            <img class="product__img" src="assets/img/product/category/category-home-1-img-4.jpg" alt="">
                                        </a>
                                        <a href="shop-1.html" class="product__link product__link--weight-regular m-t-30">
                                            Communication
                                        </a>
                                ...
                                <div class="product__box product__box--catagory  product__box--border swiper-slide text-center">
                                    <div class="product__img-box">
                                        <a href="shop-1.html" class="product__img--link">
                                            <img class="product__img" src="assets/img/product/category/category-home-1-img-5.jpg" alt="">
                                        </a>
                                        <a href="shop-1.html" class="product__link product__link--weight-regular m-t-30">
                                            Computer
                                        </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-content section-content--border d-md-flex align-items-center justify-content-between">
                            <h5 class="section-content__title">Sản phẩm xem nhiều nhất</h5>
                            <ul class="tablist tablist--style-blue tablist--style-gap-20 nav">
                                <li><a class="nav-link active" data-toggle="tab" href="#man">Nam</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#female">Nữ</a></li>
                                <li><a class="nav-link" data-toggle="tab" href="#children">Trẻ Em</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="product-large-tab-box">
                            <div class="tab-content tab-animate-zoom">
                                <div class="tab-pane show active" id="man">
                                                            ...
                                                            <div class="product__box product__box--lg-hr product__box--border-hover">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--medium btn--gray btn--uppercase btn--weight">Add to cart</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="product__box product__box--md product__box--border-hover">
                                                                        <div class="row align-items-center">
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="product__img-box">
                                                                                    <a href="single-1.html" class="product__img--link">
                                                                                        <img class="product__img" src="assets/img/product/size-normal/product-home-1-img-10.jpg" alt="">
                                                                                    </a>
                                                                                    <span class="product__tag product__tag--new">New</span>
                                                                                    <a href="wishlist.html" class="product__wishlist-icon"><i class="icon-heart"></i></a>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                ...
                                                                                <a href="single-1.html" class="product__link product__link--underline product__link--weight-light text-overflow-ellipsis m-t-15">
                                                                        ...
                                                                        <div class="row align-items-center">
                                                                            ...
                                                                            <div class="col-12 col-sm-6">
                                                                                <div class="product__price">
                                                                                    ...
                                                                                    <span class="product__price-reg">$7.92</span>
                                                                                </div>
                                                                                <a href="single-1.html" class="product__link product__link--underline product__link--weight-light text-overflow-ellipsis m-t-15">
                                                                                    P-Series 4K UHD Dolby Vision HDR Roku Smart TV
                                                                                </a>
                                                                                <a href="#modalAddCart" data-toggle="modal" class="btn btn--box btn--block btn--small btn--gray btn--uppercase btn--weight btn--hover-zoom m-t-25">Add to cart</a>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="product__box product__box--lg-hr product__box--border-hover">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6">
                                                                        <div class="product__img-box">
                                                                            <a href="single-1.html" class="product__img--link">
                                                                                <img class="product__img" src="assets/img/product/size-large/product-home-1-lg-img-2.jpg" alt="">
                                                                            </a>
                                                                            <span class="product__tag product__tag--new">New</span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="product__box product__box--lg-hr product__box--border-hover">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6">
                                                                        <div class="product__img-box">
                                                                            <a href="single-1.html" class="product__img--link">
                                                                                <img class="product__img" src="assets/img/product/size-large/product-home-1-lg-img-3.jpg" alt="">
                                                                            </a>
                                                                            <span class="product__tag product__tag--new">New</span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="product__box product__box--lg-hr product__box--border-hover">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-6">
                                                                        <div class="product__img-box">
                                                                            <a href="single-1.html" class="product__img--link">
                                                                                <img class="product__img" src="assets/img/product/size-large/product-home-1-lg-img-4.jpg" alt="">
                                                                            </a>
                                                                            <span class="product__tag product__tag--new">New</span>
                                                                        </div>
                                                                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-content section-content--border d-flex align-items-center justify-content-between">
                            <h5 class="section-content__title">Sản phẩm tổng hợp </h5>
                            <a href="single-1.html">Xem toàn bộ sản phẩm <i class="icon-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="blog blog--1 gray-bg p-tb-100 swiper-outside-arrow-hover">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-content section-content--border d-flex align-items-center justify-content-between">
                            <h5 class="section-content__title">Danh sách bài viết</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="blog-news blog-news-3grid overflow-hidden  m-t-50">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="blog-news__box swiper-slide text-center">
                                        <div class="blog-news__img-box">
                                            <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                <img src="assets/img/blog/news/blog-news-home-1-img-2.jpg" alt="" class="blog-news__img">
                                            </a>
                                        </div>
                                    ...
                                    <div class="blog-news__box swiper-slide text-center">
                                        <div class="blog-news__img-box">
                                            <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                <img src="assets/img/blog/news/blog-news-home-1-img-3.jpg" alt="" class="blog-news__img">
                                            </a>
                                        </div>
                                    ...
                                    <div class="blog-news__box swiper-slide text-center">
                                        <div class="blog-news__img-box">
                                            <a href="blog-single-left-sidebar.html" class="blog-news__img--link">
                                                <img src="assets/img/blog/news/blog-news-home-1-img-4.jpg" alt="" class="blog-news__img">
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-1.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-2.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-3.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-4.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-5.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-6.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-7.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-8.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-9.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
                                        <a href="#" class="company-logo__link">
                                            <img src="assets/img/company-logo/company-logo-10.jpg" alt="" class="company-logo__img">
                                        </a>
                                    </div> <!-- End Single Company Logo Item -->
                                    <!-- Start Single Company Logo Item -->
                                    <div class="company-logo__item swiper-slide">
